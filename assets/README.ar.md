...
### الترخيص
GPL-3.0-or-later. تراخيص وإشعارات الجهات الخارجية: [THIRD_PARTY_NOTICES.md](https://github.com/Haperone/local-image-compress/blob/main/THIRD_PARTY_NOTICES.md).
