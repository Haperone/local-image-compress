...
function getUserLang(app) {
  try {
    const detected = typeof import_obsidian2.getLanguage === "function" ? import_obsidian2.getLanguage() : app?.getLanguage?.();
...
var SettingsTab = class extends import_obsidian.PluginSettingTab {
  ...
  async display() {
    ...
    new import_obsidian.Setting(containerEl)
      .setName(`${this.plugin.manifest?.name || "Local Image Compress"} — ${t(this.plugin.app, "settings.title")}`)
      .setHeading();
    ...
    const modal = new class extends import_obsidian2.Modal {
      onOpen() {
        ...
        new import_obsidian2.Setting(contentEl)
          .setName(`${this.manifest?.name || "Local Image Compress"}: ${t(this.app, "backups.cache.title")}`)
          .setHeading();
  ...
  showMoveProgressModal(totalFiles) {
    const modal = new class extends import_obsidian2.Modal {
      ...
      onOpen() {
        ...
        new import_obsidian2.Setting(contentEl)
          .setName(`${this.manifest?.name || "Local Image Compress"}: ${t(this.app, "move.title")}`)
          .setHeading();
