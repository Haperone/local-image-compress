...
Сжимает PNG и JPEG файлы в хранилище с помощью локальных бинарников `pngquant` и `mozjpeg`. Работает офлайн, поддерживает пакетную обработку, опциональную автоматизацию и создаёт резервные копии при перемещении оптимизированных изображений.
