...
const jsMd5License = readText("licenses/js-md5.txt");
const jsSha256License = readText("licenses/js-sha256.txt");
...
const installedJsMd5License = fs.readFileSync(path.join(sourceRoot, "node_modules", "js-md5", "LICENSE.txt"), "utf8");
const installedJsSha256License = fs.readFileSync(path.join(sourceRoot, "node_modules", "js-sha256", "LICENSE.txt"), "utf8");
...
assert(jsMd5License === installedJsMd5License, "Tracked js-md5 license does not match the pinned package");
assert(jsSha256License === installedJsSha256License, "Tracked js-sha256 license does not match the pinned package");
